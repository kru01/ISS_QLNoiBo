...
namespace ISS_QLNoiBo.Main_Forms
{
    public partial class Privileges : Form
    {
        ...
        private void Privileges_Load(object sender, EventArgs e)
        {
            ...
            String sql = "SELECT GRANTEE, OWNER, TABLE_NAME, GRANTOR, PRIVILEGE, GRANTABLE, \"TYPE\" " +
                "FROM (SELECT * FROM DBA_TAB_PRIVS WHERE GRANTEE IN " +
        ...
        private void grant2Button_Click(object sender, EventArgs e)
        {
            ...
            String sqlSe = "SELECT GRANTEE, OWNER, TABLE_NAME, GRANTOR, PRIVILEGE, GRANTABLE, \"TYPE\""
                + $"FROM DBA_TAB_PRIVS WHERE GRANTEE = '{textBox1.Text}'";
