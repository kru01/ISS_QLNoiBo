...
-- In policies.sql, NHANVIEN (NV) was not granted SELECT on NHANSU, but on
--  V_NHANSU_NV instead. Hence, to facilitate the scenario, NV will be
--  temporarily granted SELECT on NHANSU.
GRANT SELECT ON A01_QLNOIBO.NHANSU TO NV0001, NV0002, NV0003;

-- NV0001 WON'T TRIGGER THE AUDIT
CONN NV0001/123@LOCALHOST:1521/XEPDB1;
SELECT * FROM A01_QLNOIBO.NHANSU WHERE MANV = 'NV0001';
-- NV0002 WON'T TRIGGER THE AUDIT
CONN NV0002/123@LOCALHOST:1521/XEPDB1;
SELECT HOTEN FROM A01_QLNOIBO.NHANSU WHERE MANV = 'NV0001';
-- NV0003 WILL TRIGGER THE AUDIT
CONN NV0003/123@LOCALHOST:1521/XEPDB1;
SELECT * FROM A01_QLNOIBO.NHANSU WHERE MANV = 'NV0001';
...
REVOKE SELECT ON A01_QLNOIBO.NHANSU FROM NV0001, NV0002, NV0003;
