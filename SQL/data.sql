...
INSERT INTO COSO
	SELECT 0, 'DAI HOC X' FROM DUAL UNION ALL
	SELECT 1, 'CO SO 1' FROM DUAL UNION ALL
	SELECT 2, 'CO SO 2' FROM DUAL;
...
-- 1. NHAN VIEN CO BAN - 1. VAN PHONG KHOA
    SELECT 'NV0001', 'Hoang Phuong Tra', 'NU', TO_DATE('28/07/1980', 'DD/MM/YYYY'), 2427, '09935466760', 1, 1, 1 FROM DUAL UNION ALL
    SELECT 'NV0002', 'Duong Thi Cam', 'NU', TO_DATE('28/02/1995', 'DD/MM/YYYY'), 6947, '09397762249', 1, 1, 1 FROM DUAL UNION ALL
    SELECT 'NV0003', 'Bui Dieu Hong', 'NU', TO_DATE('31/08/1992', 'DD/MM/YYYY'), 6992, '09425872787', 1, 1, 1 FROM DUAL UNION ALL
    SELECT 'NV0004', 'Ngo Huu Phuoc', 'NAM', TO_DATE('19/02/1971', 'DD/MM/YYYY'), 9274, '09691907243', 1, 1, 1 FROM DUAL UNION ALL
    SELECT 'NV0005', 'Dinh Duc Bao', 'NAM', TO_DATE('25/01/1977', 'DD/MM/YYYY'), 5885, '09768751682', 1, 1, 1 FROM DUAL UNION ALL
    SELECT 'NV0006', 'Huynh Thanh Loi', 'NAM', TO_DATE('08/07/1981', 'DD/MM/YYYY'), 1353, '09498783423', 1, 1, 2 FROM DUAL UNION ALL
    SELECT 'NV0007', 'Bui Thi Cam', 'NU', TO_DATE('21/05/1995', 'DD/MM/YYYY'), 4611, '09168500805', 1, 1, 2 FROM DUAL UNION ALL
    SELECT 'NV0008', 'Truong Mong Van', 'NU', TO_DATE('23/09/1994', 'DD/MM/YYYY'), 9981, '09705491149', 1, 1, 2 FROM DUAL UNION ALL
    SELECT 'NV0009', 'Pham Anh Minh', 'NAM', TO_DATE('04/10/1972', 'DD/MM/YYYY'), 8190, '09353695402', 1, 1, 2 FROM DUAL UNION ALL
    SELECT 'NV0010', 'Ho Gia Duc', 'NAM', TO_DATE('02/03/1975', 'DD/MM/YYYY'), 4716, '09698527961', 1, 1, 2 FROM DUAL UNION ALL
-- 3. GIAO VU - 1. VAN PHONG KHOA
    SELECT 'GV0001', 'Duong Yen Trang', 'NU', TO_DATE('24/08/1982', 'DD/MM/YYYY'), 8554, '09561464695', 3, 1, 1 FROM DUAL UNION ALL
    SELECT 'GV0002', 'Duong Kim Thao', 'NU', TO_DATE('05/02/1997', 'DD/MM/YYYY'), 8548, '09403850427', 3, 1, 1 FROM DUAL UNION ALL
    SELECT 'GV0003', 'Dinh Thanh Hanh', 'NU', TO_DATE('10/07/1991', 'DD/MM/YYYY'), 9374, '09438731171', 3, 1, 1 FROM DUAL UNION ALL
    SELECT 'GV0004', 'Bui Hieu Lam', 'NAM', TO_DATE('27/12/1986', 'DD/MM/YYYY'), 7385, '09383998067', 3, 1, 1 FROM DUAL UNION ALL
    SELECT 'GV0005', 'Phan Thanh Son', 'NAM', TO_DATE('01/02/1976', 'DD/MM/YYYY'), 4970, '09482893902', 3, 1, 1 FROM DUAL UNION ALL
    SELECT 'GV0006', 'Huynh Thuy Hien', 'NU', TO_DATE('25/10/1975', 'DD/MM/YYYY'), 5758, '09518356923', 3, 1, 2 FROM DUAL UNION ALL
    SELECT 'GV0007', 'Vo Viet Phong', 'NAM', TO_DATE('09/11/1972', 'DD/MM/YYYY'), 4375, '09266472531', 3, 1, 2 FROM DUAL UNION ALL
    SELECT 'GV0008', 'Ly Minh Thien', 'NAM', TO_DATE('09/10/1973', 'DD/MM/YYYY'), 2899, '09736576222', 3, 1, 2 FROM DUAL UNION ALL
    SELECT 'GV0009', 'Vu An Khe', 'NU', TO_DATE('03/09/1980', 'DD/MM/YYYY'), 5260, '09659964719', 3, 1, 2 FROM DUAL UNION ALL
    SELECT 'GV0010', 'Do Thao Hong', 'NU', TO_DATE('22/09/1980', 'DD/MM/YYYY'), 3955, '09737456988', 3, 1, 2 FROM DUAL UNION ALL
-- 4. TRUONG DON VI - 2. HTTT, 3. CNPM, 4. KHMT, 5. CNTT, 6. TGMT, 7. MMT
    SELECT 'TD0001', 'Duong Bao Hue', 'NU', TO_DATE('04/07/1995', 'DD/MM/YYYY'), 9597, '09480787174', 4, 2, 1 FROM DUAL UNION ALL
    SELECT 'TD0002', 'Do Chi Nam', 'NAM', TO_DATE('16/05/1982', 'DD/MM/YYYY'), 1729, '09372403011', 4, 3, 1 FROM DUAL UNION ALL
    SELECT 'TD0003', 'Hoang Thuy Van', 'NU', TO_DATE('09/07/1972', 'DD/MM/YYYY'), 1930, '09550783443', 4, 4, 1 FROM DUAL UNION ALL
    SELECT 'TD0004', 'Le Quang Vu', 'NAM', TO_DATE('27/07/1994', 'DD/MM/YYYY'), 9511, '09948400459', 4, 5, 1 FROM DUAL UNION ALL
    SELECT 'TD0005', 'Huynh Thien Theu', 'NU', TO_DATE('04/08/1997', 'DD/MM/YYYY'), 2513, '09714491762', 4, 6, 1 FROM DUAL UNION ALL
    SELECT 'TD0006', 'Dang My Ngoc', 'NU', TO_DATE('24/12/1996', 'DD/MM/YYYY'), 512, '09222394868', 4, 7, 1 FROM DUAL UNION ALL
	SELECT 'TD0007', 'Ho Thanh Tu', 'NAM', TO_DATE('04/10/1990', 'DD/MM/YYYY'), 1025, '09897733006', 4, 2, 2 FROM DUAL UNION ALL
	SELECT 'TD0008', 'Hoang Xuan Thanh', 'NU', TO_DATE('13/05/1990', 'DD/MM/YYYY'), 1736, '09176683074', 4, 3, 2 FROM DUAL UNION ALL
	SELECT 'TD0009', 'Do Viet Tan', 'NAM', TO_DATE('25/06/1971', 'DD/MM/YYYY'), 3324, '09867368926', 4, 4, 2 FROM DUAL UNION ALL
	SELECT 'TD0010', 'Vo Truc Vy', 'NU', TO_DATE('09/10/1982', 'DD/MM/YYYY'), 6267, '09783802740', 4, 5, 2 FROM DUAL UNION ALL
	SELECT 'TD0011', 'Pham Phuong Tra', 'NU', TO_DATE('26/04/1991', 'DD/MM/YYYY'), 2653, '09257710334', 4, 6, 2 FROM DUAL UNION ALL
	SELECT 'TD0012', 'Do Chi Anh', 'NAM', TO_DATE('27/10/1995', 'DD/MM/YYYY'), 4120, '09326442500', 4, 7, 2 FROM DUAL UNION ALL
-- 5. TRUONG KHOA - 1. VAN PHONG KHOA
    SELECT 'TK0001', 'Nguyen Van Anh', 'NAM', TO_DATE('01/01/1980', 'DD/MM/YYYY'), 10000, '09123456789', 5, 1, 0 FROM DUAL;
INSERT INTO NHANSU
-- 2.2. GIANG VIEN HTTT (10)
	SELECT 'V20001', 'Do Bao Phap', 'NAM', TO_DATE('12/01/1992', 'DD/MM/YYYY'), 2124, '09174882669', 2, 2, 1 FROM DUAL UNION ALL
	SELECT 'V20002', 'Ly Da Nguyet', 'NU', TO_DATE('28/03/1985', 'DD/MM/YYYY'), 773, '09804104706', 2, 2, 1 FROM DUAL UNION ALL
	SELECT 'V20003', 'Pham Phuong Phi', 'NAM', TO_DATE('05/02/1984', 'DD/MM/YYYY'), 926, '09711726859', 2, 2, 1 FROM DUAL UNION ALL
	SELECT 'V20004', 'Nguyen Mai Lien', 'NU', TO_DATE('26/09/1997', 'DD/MM/YYYY'), 1972, '09577169947', 2, 2, 1 FROM DUAL UNION ALL
	SELECT 'V20005', 'Nguyen Thuy Quynh', 'NU', TO_DATE('07/02/1992', 'DD/MM/YYYY'), 1731, '09158215036', 2, 2, 1 FROM DUAL UNION ALL
	SELECT 'V20006', 'Hoang Kieu Anh', 'NU', TO_DATE('18/03/1996', 'DD/MM/YYYY'), 565, '09762471146', 2, 2, 2 FROM DUAL UNION ALL
	SELECT 'V20007', 'Pham Kieu Trinh', 'NU', TO_DATE('18/10/1989', 'DD/MM/YYYY'), 1556, '09522614990', 2, 2, 2 FROM DUAL UNION ALL
	SELECT 'V20008', 'Vu Bao Huy', 'NAM', TO_DATE('24/02/1989', 'DD/MM/YYYY'), 1270, '09443021543', 2, 2, 2 FROM DUAL UNION ALL
	SELECT 'V20009', 'Vu Chanh Viet', 'NAM', TO_DATE('10/04/1979', 'DD/MM/YYYY'), 5206, '09959946572', 2, 2, 2 FROM DUAL UNION ALL
	SELECT 'V20010', 'Bui Hai Duyen', 'NU', TO_DATE('14/08/1971', 'DD/MM/YYYY'), 9973, '09434584487', 2, 2, 2 FROM DUAL;
INSERT INTO NHANSU
-- 2.3. GIANG VIEN CNPM (10)
	SELECT 'V30011', 'Tran Bich Ngan', 'NU', TO_DATE('21/05/1985', 'DD/MM/YYYY'), 3404, '09253648946', 2, 3, 1 FROM DUAL UNION ALL
	SELECT 'V30012', 'Nguyen Thien Mai', 'NU', TO_DATE('28/01/1975', 'DD/MM/YYYY'), 2001, '09575071882', 2, 3, 1 FROM DUAL UNION ALL
	SELECT 'V30013', 'Truong Hanh Dung', 'NU', TO_DATE('15/08/1979', 'DD/MM/YYYY'), 652, '09323216809', 2, 3, 1 FROM DUAL UNION ALL
	SELECT 'V30014', 'Huynh Minh Hieu', 'NAM', TO_DATE('29/01/1992', 'DD/MM/YYYY'), 1777, '09775416992', 2, 3, 1 FROM DUAL UNION ALL
	SELECT 'V30015', 'Phan Quynh Tien', 'NU', TO_DATE('22/08/1983', 'DD/MM/YYYY'), 7117, '09350180856', 2, 3, 1 FROM DUAL UNION ALL
	SELECT 'V30016', 'Phan Lan Chi', 'NU', TO_DATE('08/06/1973', 'DD/MM/YYYY'), 1047, '09238110266', 2, 3, 2 FROM DUAL UNION ALL
	SELECT 'V30017', 'Pham Bao Hoang', 'NAM', TO_DATE('25/06/1975', 'DD/MM/YYYY'), 551, '09472980319', 2, 3, 2 FROM DUAL UNION ALL
	SELECT 'V30018', 'Tran Chan Hung', 'NAM', TO_DATE('02/08/1976', 'DD/MM/YYYY'), 4088, '09305647391', 2, 3, 2 FROM DUAL UNION ALL
	SELECT 'V30019', 'Le Tuyet Oanh', 'NU', TO_DATE('05/05/1990', 'DD/MM/YYYY'), 9601, '09081297271', 2, 3, 2 FROM DUAL UNION ALL
	SELECT 'V30020', 'Tran Khanh Giao', 'NU', TO_DATE('09/08/1982', 'DD/MM/YYYY'), 6117, '09175280918', 2, 3, 2 FROM DUAL;
INSERT INTO NHANSU
-- 2.4. GIANG VIEN KHMT (10)
	SELECT 'V40021', 'Ngo Dinh Loc', 'NAM', TO_DATE('04/08/1974', 'DD/MM/YYYY'), 7756, '09083844777', 2, 4, 1 FROM DUAL UNION ALL
	SELECT 'V40022', 'Truong Minh Hue', 'NU', TO_DATE('03/02/1986', 'DD/MM/YYYY'), 1689, '09119131441', 2, 4, 1 FROM DUAL UNION ALL
	SELECT 'V40023', 'Bui Truc Chi', 'NU', TO_DATE('19/06/1995', 'DD/MM/YYYY'), 5390, '09671230253', 2, 4, 1 FROM DUAL UNION ALL
	SELECT 'V40024', 'Hoang Anh Minh', 'NAM', TO_DATE('24/10/1999', 'DD/MM/YYYY'), 7364, '09168097082', 2, 4, 1 FROM DUAL UNION ALL
	SELECT 'V40025', 'Duong Duy An', 'NAM', TO_DATE('06/01/1993', 'DD/MM/YYYY'), 8030, '09319833207', 2, 4, 1 FROM DUAL UNION ALL
	SELECT 'V40026', 'Vo The Trung', 'NAM', TO_DATE('13/01/1998', 'DD/MM/YYYY'), 2904, '09604416975', 2, 4, 2 FROM DUAL UNION ALL
	SELECT 'V40027', 'Dang Boi Linh', 'NU', TO_DATE('22/10/1981', 'DD/MM/YYYY'), 5746, '09844434984', 2, 4, 2 FROM DUAL UNION ALL
	SELECT 'V40028', 'Tran Nhan Hong', 'NU', TO_DATE('11/02/1986', 'DD/MM/YYYY'), 2857, '09597692536', 2, 4, 2 FROM DUAL UNION ALL
	SELECT 'V40029', 'Truong Huu Hung', 'NAM', TO_DATE('24/10/1970', 'DD/MM/YYYY'), 1270, '09863809781', 2, 4, 2 FROM DUAL UNION ALL
	SELECT 'V40030', 'Pham Thuy Ðao', 'NU', TO_DATE('14/09/1985', 'DD/MM/YYYY'), 9990, '09161942987', 2, 4, 2 FROM DUAL;
INSERT INTO NHANSU
-- 2.5. GIANG VIEN CNTT (10)
	SELECT 'V50031', 'Truong Huyen Trang', 'NU', TO_DATE('19/02/1993', 'DD/MM/YYYY'), 7430, '09362219216', 2, 5, 1 FROM DUAL UNION ALL
	SELECT 'V50032', 'Duong Kieu Mai', 'NU', TO_DATE('27/11/1991', 'DD/MM/YYYY'), 8432, '09550066755', 2, 5, 1 FROM DUAL UNION ALL
	SELECT 'V50033', 'Hoang Phuong Nghi', 'NU', TO_DATE('24/08/1985', 'DD/MM/YYYY'), 3762, '09554908420', 2, 5, 1 FROM DUAL UNION ALL
	SELECT 'V50034', 'Dinh Hong Thuy', 'NU', TO_DATE('14/10/1986', 'DD/MM/YYYY'), 3057, '09479014952', 2, 5, 1 FROM DUAL UNION ALL
	SELECT 'V50035', 'Hoang Kim Vuong', 'NAM', TO_DATE('31/08/1979', 'DD/MM/YYYY'), 7066, '09132136132', 2, 5, 1 FROM DUAL UNION ALL
	SELECT 'V50036', 'Ho Ai Thy', 'NU', TO_DATE('24/05/1990', 'DD/MM/YYYY'), 9955, '09653194727', 2, 5, 2 FROM DUAL UNION ALL
	SELECT 'V50037', 'Phan That Cuong', 'NAM', TO_DATE('14/01/1971', 'DD/MM/YYYY'), 8384, '09165814895', 2, 5, 2 FROM DUAL UNION ALL
	SELECT 'V50038', 'Ho Son Tung', 'NAM', TO_DATE('13/02/1972', 'DD/MM/YYYY'), 8288, '09481324391', 2, 5, 2 FROM DUAL UNION ALL
	SELECT 'V50039', 'Vu Tuyet Hong', 'NU', TO_DATE('02/11/1982', 'DD/MM/YYYY'), 3924, '09154416688', 2, 5, 2 FROM DUAL UNION ALL
	SELECT 'V50040', 'Tran Thuong Khang', 'NAM', TO_DATE('13/07/1986', 'DD/MM/YYYY'), 8538, '09979707230', 2, 5, 2 FROM DUAL;
INSERT INTO NHANSU
-- 2.6. GIANG VIEN TGMT (10)
	SELECT 'V60041', 'Pham Xuan Kien', 'NAM', TO_DATE('15/03/1972', 'DD/MM/YYYY'), 8488, '09175463609', 2, 6, 1 FROM DUAL UNION ALL
	SELECT 'V60042', 'Dang Phuong Tien', 'NU', TO_DATE('12/08/1977', 'DD/MM/YYYY'), 8467, '09484278997', 2, 6, 1 FROM DUAL UNION ALL
	SELECT 'V60043', 'Hoang Uy Phong', 'NAM', TO_DATE('16/01/1999', 'DD/MM/YYYY'), 7442, '09539734716', 2, 6, 1 FROM DUAL UNION ALL
	SELECT 'V60044', 'Phan Truc Dao', 'NU', TO_DATE('25/10/1995', 'DD/MM/YYYY'), 2084, '09009924120', 2, 6, 1 FROM DUAL UNION ALL
	SELECT 'V60045', 'Hoang Thien Duc', 'NAM', TO_DATE('16/04/1970', 'DD/MM/YYYY'), 7884, '09968736755', 2, 6, 1 FROM DUAL UNION ALL
	SELECT 'V60046', 'Ly Thao Nhi', 'NU', TO_DATE('12/12/1993', 'DD/MM/YYYY'), 5076, '09648987510', 2, 6, 2 FROM DUAL UNION ALL
	SELECT 'V60047', 'Vu Phuong Nghi', 'NU', TO_DATE('18/09/1996', 'DD/MM/YYYY'), 6887, '09300310032', 2, 6, 2 FROM DUAL UNION ALL
	SELECT 'V60048', 'Vo Nam Thanh', 'NAM', TO_DATE('07/01/1974', 'DD/MM/YYYY'), 4996, '09195093517', 2, 6, 2 FROM DUAL UNION ALL
	SELECT 'V60049', 'Vo Trung Thuc', 'NAM', TO_DATE('24/09/1988', 'DD/MM/YYYY'), 6451, '09156892087', 2, 6, 2 FROM DUAL UNION ALL
	SELECT 'V60050', 'Le Hai Phong', 'NAM', TO_DATE('19/08/1983', 'DD/MM/YYYY'), 3278, '09879535204', 2, 6, 2 FROM DUAL;
INSERT INTO NHANSU
-- 2.7. GIANG VIEN MMT (10)
	SELECT 'V70051', 'Nguyen Viet Yen', 'NU', TO_DATE('28/12/1985', 'DD/MM/YYYY'), 3407, '09632988669', 2, 7, 1 FROM DUAL UNION ALL
	SELECT 'V70052', 'Dinh Ngoc Ðao', 'NU', TO_DATE('17/05/1996', 'DD/MM/YYYY'), 1157, '09298113642', 2, 7, 1 FROM DUAL UNION ALL
	SELECT 'V70053', 'Bui Tuan Thanh', 'NAM', TO_DATE('02/04/1995', 'DD/MM/YYYY'), 3133, '09011499682', 2, 7, 1 FROM DUAL UNION ALL
	SELECT 'V70054', 'Dinh Trung Chinh', 'NAM', TO_DATE('09/09/1981', 'DD/MM/YYYY'), 3472, '09871107222', 2, 7, 1 FROM DUAL UNION ALL
	SELECT 'V70055', 'Nguyen Duc Long', 'NAM', TO_DATE('23/05/1973', 'DD/MM/YYYY'), 9595, '09920292050', 2, 7, 1 FROM DUAL UNION ALL
	SELECT 'V70056', 'Dinh Minh Vu', 'NAM', TO_DATE('31/10/1984', 'DD/MM/YYYY'), 1711, '09536318555', 2, 7, 2 FROM DUAL UNION ALL
	SELECT 'V70057', 'Ngo Tan Dung', 'NAM', TO_DATE('19/10/1973', 'DD/MM/YYYY'), 5346, '09071027805', 2, 7, 2 FROM DUAL UNION ALL
	SELECT 'V70058', 'Pham Van Ly', 'NAM', TO_DATE('15/03/1987', 'DD/MM/YYYY'), 4192, '09779720821', 2, 7, 2 FROM DUAL UNION ALL
	SELECT 'V70059', 'Dinh Xuan Minh', 'NAM', TO_DATE('05/03/1979', 'DD/MM/YYYY'), 8410, '09041642698', 2, 7, 2 FROM DUAL UNION ALL
	SELECT 'V70060', 'Nguyen Mong Lan', 'NU', TO_DATE('25/07/1971', 'DD/MM/YYYY'), 7971, '09470775032', 2, 7, 2 FROM DUAL;
INSERT INTO NHANSU
-- 2.2. GIANG VIEN HTTT (5)
	SELECT 'V20061', 'Nguyen Phuong Thao', 'NU', TO_DATE('02/04/1991', 'DD/MM/YYYY'), 2063, '09736614815', 2, 2, 1 FROM DUAL UNION ALL
	SELECT 'V20062', 'Ho Hai San', 'NU', TO_DATE('25/06/1971', 'DD/MM/YYYY'), 943, '09785063723', 2, 2, 1 FROM DUAL UNION ALL
	SELECT 'V20063', 'Ho An Binh', 'NU', TO_DATE('15/02/1980', 'DD/MM/YYYY'), 4828, '09692404621', 2, 2, 1 FROM DUAL UNION ALL
	SELECT 'V20064', 'Dinh Xuan Thanh', 'NU', TO_DATE('23/02/1985', 'DD/MM/YYYY'), 7280, '09510645493', 2, 2, 1 FROM DUAL UNION ALL
	SELECT 'V20065', 'Duong Thai Binh', 'NAM', TO_DATE('29/12/1982', 'DD/MM/YYYY'), 4547, '09835258751', 2, 2, 1 FROM DUAL UNION ALL
-- 2.3. GIANG VIEN CNPM (5)
	SELECT 'V30066', 'Truong My Duyen', 'NU', TO_DATE('23/05/1993', 'DD/MM/YYYY'), 3938, '09616491842', 2, 3, 1 FROM DUAL UNION ALL
	SELECT 'V30067', 'Bui Lien Huong', 'NU', TO_DATE('13/03/1975', 'DD/MM/YYYY'), 8755, '09055963257', 2, 3, 1 FROM DUAL UNION ALL
	SELECT 'V30068', 'Phan Thai To', 'NAM', TO_DATE('16/03/1989', 'DD/MM/YYYY'), 9668, '09362356081', 2, 3, 1 FROM DUAL UNION ALL
	SELECT 'V30069', 'Bui Duc Anh', 'NAM', TO_DATE('22/11/1981', 'DD/MM/YYYY'), 4474, '09390208559', 2, 3, 1 FROM DUAL UNION ALL
	SELECT 'V30070', 'Dinh Thach Thao', 'NU', TO_DATE('10/08/1973', 'DD/MM/YYYY'), 8456, '09292009236', 2, 3, 1 FROM DUAL UNION ALL
-- 2.4. GIANG VIEN KHMT (5)
	SELECT 'V40071', 'Duong Hoang Long', 'NAM', TO_DATE('05/05/1980', 'DD/MM/YYYY'), 9242, '09219050616', 2, 4, 1 FROM DUAL UNION ALL
	SELECT 'V40072', 'Hoang Nhat Linh', 'NU', TO_DATE('26/11/1981', 'DD/MM/YYYY'), 2626, '09037421323', 2, 4, 1 FROM DUAL UNION ALL
	SELECT 'V40073', 'Nguyen Thi Thi', 'NU', TO_DATE('07/02/1977', 'DD/MM/YYYY'), 7149, '09233674546', 2, 4, 1 FROM DUAL UNION ALL
	SELECT 'V40074', 'Tran Huyen Thoai', 'NU', TO_DATE('14/02/1996', 'DD/MM/YYYY'), 2396, '09604336667', 2, 4, 1 FROM DUAL UNION ALL
	SELECT 'V40075', 'Ly Huu Chau', 'NAM', TO_DATE('03/01/1984', 'DD/MM/YYYY'), 1233, '09053213118', 2, 4, 1 FROM DUAL UNION ALL
-- 2.5. GIANG VIEN CNTT (5)
	SELECT 'V50076', 'Hoang Thao Huong', 'NU', TO_DATE('26/09/1973', 'DD/MM/YYYY'), 6948, '09286026118', 2, 5, 1 FROM DUAL UNION ALL
	SELECT 'V50077', 'Pham Van Tuyen', 'NAM', TO_DATE('04/11/1974', 'DD/MM/YYYY'), 8673, '09467171583', 2, 5, 1 FROM DUAL UNION ALL
	SELECT 'V50078', 'Dinh Xuan Hoa', 'NAM', TO_DATE('24/02/1996', 'DD/MM/YYYY'), 2770, '09782489677', 2, 5, 1 FROM DUAL UNION ALL
	SELECT 'V50079', 'Dang Quynh Huong', 'NU', TO_DATE('11/12/1977', 'DD/MM/YYYY'), 7322, '09233478750', 2, 5, 1 FROM DUAL UNION ALL
	SELECT 'V50080', 'Duong Bao Truc', 'NU', TO_DATE('07/02/1975', 'DD/MM/YYYY'), 3762, '09793385631', 2, 5, 1 FROM DUAL;
...
-- 1. SINH VIEN HTTT
--	1. CQ
	SELECT 'S10001', 'Ho Hai Duyen', 'NU', TO_DATE('04/07/2000', 'DD/MM/YYYY'), '54B duong Quan 8, phuong Cua Dong, Quan 12, Thanh pho Tra Vinh, Tinh Tra Vinh', '09901102603', 'CQ', 'HTTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10002', 'Tran Cam Nhi', 'NU', TO_DATE('22/07/2001', 'DD/MM/YYYY'), '358/13Z duong Hong Bang, phuong Cua Nam, Thanh pho Ha Giang, Tinh Ha Giang', '09295615023', 'CQ', 'HTTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10003', 'Vo My Xuan', 'NU', TO_DATE('03/07/2003', 'DD/MM/YYYY'), '18/41 duong Le Chan, phuong Lac Vien, Quan 10, Thanh pho Ha Tinh, Tinh Ha Tinh', '09729150198', 'CQ', 'HTTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10004', 'Tran Quoc Toan', 'NAM', TO_DATE('20/01/2004', 'DD/MM/YYYY'), '15/11H duong Tay Ho, phuong Da Kao, quan Bac Tu Liem, Thanh pho Ben Tre, Tinh Ben Tre', '09033967798', 'CQ', 'HTTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10005', 'Le Xuan Lac', 'NAM', TO_DATE('15/01/2001', 'DD/MM/YYYY'), '147/17 duong Hai Ba Trung, phuong May To, Thanh pho Phan Thiet, Tinh Binh Thuan', '09245501649', 'CQ', 'HTTT', 0, 0, 1 FROM DUAL UNION ALL
--	2. CLC
	SELECT 'S20006', 'Pham Bao Dinh', 'NAM', TO_DATE('20/03/2000', 'DD/MM/YYYY'), '327L duong Binh Tan, phuong Hoa Tho Tay, Thanh pho Hue, Tinh Thua Thien Hue', '09916101939', 'CLC', 'HTTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20007', 'Bui Thanh Tinh', 'NAM', TO_DATE('25/03/2001', 'DD/MM/YYYY'), '62 duong Quan 12, phuong Cua Dong, quan Lien Chieu, Thanh pho Tuy Hoa, Tinh Phu Yen', '09514372983', 'CLC', 'HTTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20008', 'Huynh Canh Tuan', 'NAM', TO_DATE('02/07/2005', 'DD/MM/YYYY'), '343N duong Son Tra, phuong Thanh Khe Dong, Thanh pho Bac Kan, Tinh Bac Kan', '09317409036', 'CLC', 'HTTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20009', 'Dang Hoa Thai', 'NAM', TO_DATE('08/01/2003', 'DD/MM/YYYY'), '103 duong Tan Binh, phuong Dong Nhan, Thanh pho Ninh Binh, Tinh Ninh Binh', '09596631449', 'CLC', 'HTTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20010', 'Vu Quan Duong', 'NAM', TO_DATE('12/09/2001', 'DD/MM/YYYY'), '52 duong Lien Chieu, phuong Dien Bien, Quan 12, Thanh pho Thai Nguyen, Tinh Thai Nguyen', '09086057671', 'CLC', 'HTTT', 0, 0, 1 FROM DUAL UNION ALL
--	3. CTTT
	SELECT 'S30011', 'Do Hoang Hai', 'NAM', TO_DATE('08/03/2000', 'DD/MM/YYYY'), '248/6 duong Nam Tu Liem, phuong Linh Nam, quan Duong Kinh, Thanh pho Dong Hoi, Tinh Quang Binh', '09156688487', 'CTTT', 'HTTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30012', 'Huynh Lien Hoa', 'NU', TO_DATE('25/06/2003', 'DD/MM/YYYY'), '82/22C duong Quan 7, phuong Hoa Khanh Nam, Thanh pho Phan Rang - Thap Cham, Tinh Ninh Thuan', '09813942256', 'CTTT', 'HTTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30013', 'Dang Quang Trung', 'NAM', TO_DATE('17/09/2005', 'DD/MM/YYYY'), '291/22 duong Tan Phu, phuong Tan Tao, Thanh pho Vinh Long, Tinh Vinh Long', '09628401567', 'CTTT', 'HTTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30014', 'Ngo Tam Linh', 'NU', TO_DATE('29/06/2000', 'DD/MM/YYYY'), '196S duong Tan Binh, phuong Yet Kieu, quan Nam Tu Liem, Thanh pho Can Tho', '09214035556', 'CTTT', 'HTTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30015', 'Dang Hong Ðiep', 'NU', TO_DATE('24/11/2002', 'DD/MM/YYYY'), '235M duong Lien Chieu, phuong Thoi Hoa, Thanh pho Dien Bien Phu, Tinh Dien Bien', '09097875856', 'CTTT', 'HTTT', 0, 0, 2 FROM DUAL UNION ALL
--	4. VP
	SELECT 'S40016', 'Dinh Huu Trac', 'NAM', TO_DATE('06/12/2003', 'DD/MM/YYYY'), '370 duong Ba Dinh, phuong Tan Quy, quan Ngu Hanh Son, Thanh pho Thai Nguyen, Tinh Thai Nguyen', '09998342532', 'VP', 'HTTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40017', 'Vo Cong Thanh', 'NAM', TO_DATE('04/05/2003', 'DD/MM/YYYY'), '151/41L duong Cau Giay, phuong Dong Mac, quan Hong Bang, Thanh pho Tay Ninh, Tinh Tay Ninh', '09487189727', 'VP', 'HTTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40018', 'Dang Nguyet Nga', 'NU', TO_DATE('21/03/2001', 'DD/MM/YYYY'), '43 duong Quan 11, phuong Nguyen Thai Binh, Quan 3, Thanh pho Bac Lieu, Tinh Bac Lieu', '09121598892', 'VP', 'HTTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40019', 'Ly Cong Hao', 'NAM', TO_DATE('19/06/2000', 'DD/MM/YYYY'), '136/11 duong O Mon, phuong Nguyen Trai, Quan 8, Thanh pho Cao Bang, Tinh Cao Bang', '09998013488', 'VP', 'HTTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40020', 'Dinh Minh Nguyet', 'NU', TO_DATE('09/09/2003', 'DD/MM/YYYY'), '355U duong Cau Giay, phuong An Phu Dong, quan O Mon, Thanh pho Quang Ngai, Tinh Quang Ngai', '09883782731', 'VP', 'HTTT', 0, 0, 2 FROM DUAL;
INSERT INTO SINHVIEN
-- 2. SINH VIEN CNPM
--	1. CQ
	SELECT 'S10021', 'Vo Tuan Long', 'NAM', TO_DATE('06/05/2001', 'DD/MM/YYYY'), '125/6T duong Hoan Kiem, phuong Minh Duc, Thanh pho Tra Vinh, Tinh Tra Vinh', '09548527485', 'CQ', 'CNPM', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10022', 'Dinh Que Linh', 'NU', TO_DATE('25/04/2003', 'DD/MM/YYYY'), '54/27E duong Quan 12, Phuong 17, Thanh pho Tuyen Quang, Tinh Tuyen Quang', '09284576185', 'CQ', 'CNPM', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10023', 'Bui Thuan Anh', 'NAM', TO_DATE('03/03/2002', 'DD/MM/YYYY'), '168/34 duong Ninh Kieu, Phuong 3, quan Nam Tu Liem, Thanh pho Hai Duong, Tinh Hai Duong', '09107861238', 'CQ', 'CNPM', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10024', 'Tran Thuy Anh', 'NU', TO_DATE('18/03/2001', 'DD/MM/YYYY'), '357V duong Nam Tu Liem, phuong Cau Dat, Thanh pho Tuy Hoa, Tinh Phu Yen', '09729203085', 'CQ', 'CNPM', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10025', 'Do Hieu Liem', 'NAM', TO_DATE('30/07/2000', 'DD/MM/YYYY'), '6/29 duong Ninh Kieu, phuong Khue My, quan Son Tra, Thanh pho Ba Ria, Tinh Ba Ria - Vung Tau', '09308883496', 'CQ', 'CNPM', 0, 0, 1 FROM DUAL UNION ALL
--	2. CLC
	SELECT 'S20026', 'Vu Hanh Nhon', 'NU', TO_DATE('24/03/2000', 'DD/MM/YYYY'), '129/42 duong Lien Chieu, phuong Tran Hung Dao, quan Cau Giay, Thanh pho Ninh Binh, Tinh Ninh Binh', '09780796678', 'CLC', 'CNPM', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20027', 'Le Quang Hung', 'NAM', TO_DATE('17/05/2003', 'DD/MM/YYYY'), '219V duong Duong Kinh, phuong Hoa Xuan, Thanh pho Thai Binh, Tinh Thai Binh', '09004403365', 'CLC', 'CNPM', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20028', 'Bui Lap Thanh', 'NAM', TO_DATE('11/05/2001', 'DD/MM/YYYY'), '138/26I duong Hong Bang, phuong Nghia Tan, quan Hai An, Thanh pho My Tho, Tinh Tien Giang', '09419638672', 'CLC', 'CNPM', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20029', 'Vo Phuoc Hue', 'NU', TO_DATE('12/10/2002', 'DD/MM/YYYY'), '380/33D duong Dong Da, phuong Vinh Tuy, quan Thanh Xuan, Thanh pho Vinh Long, Tinh Vinh Long', '09943174078', 'CLC', 'CNPM', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20030', 'Nguyen Ba Loc', 'NAM', TO_DATE('24/08/2001', 'DD/MM/YYYY'), '293 duong Son Tra, phuong Dai Kim, Thanh pho Bac Lieu, Tinh Bac Lieu', '09458086147', 'CLC', 'CNPM', 0, 0, 1 FROM DUAL UNION ALL
--	3. CTTT
	SELECT 'S30031', 'Dinh Hung Cuong', 'NAM', TO_DATE('09/09/2004', 'DD/MM/YYYY'), '361/38Y duong Hoang Mai, phuong Trang Tien, Quan 7, Thanh pho Tuy Hoa, Tinh Phu Yen', '09918962740', 'CTTT', 'CNPM', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30032', 'Le Huong Duong', 'NAM', TO_DATE('03/03/2005', 'DD/MM/YYYY'), '313/37E duong Go Vap, phuong Xuan Tao, quan Thanh Xuan, Thanh pho Phan Thiet, Tinh Binh Thuan', '09037466012', 'CTTT', 'CNPM', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30033', 'Tran Dan Tam', 'NU', TO_DATE('29/10/2000', 'DD/MM/YYYY'), '65/30 duong Lien Chieu, phuong Thanh To, Thanh pho Cao Lanh, Tinh Dong Thap', '09677021026', 'CTTT', 'CNPM', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30034', 'Dang Thoi Nhiem', 'NAM', TO_DATE('07/01/2004', 'DD/MM/YYYY'), '106/29 duong Hoang Mai, phuong Tan Tao A, Thanh pho Tam Ky, Tinh Quang Nam', '09137014347', 'CTTT', 'CNPM', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30035', 'Ngo Phong Do', 'NAM', TO_DATE('26/08/2005', 'DD/MM/YYYY'), '377/17P duong Cai Rang, Phuong 17, Thanh pho Da Lat, Tinh Lam Dong', '09246408579', 'CTTT', 'CNPM', 0, 0, 2 FROM DUAL UNION ALL
--	4. VP
	SELECT 'S40036', 'Tran Thien Tien', 'NU', TO_DATE('04/01/2002', 'DD/MM/YYYY'), '282P duong Nam Tu Liem, phuong Xuan Tao, Thanh pho Quy Nhon, Tinh Binh Dinh', '09003830819', 'VP', 'CNPM', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40037', 'Ho Gia Khiem', 'NAM', TO_DATE('16/07/2001', 'DD/MM/YYYY'), '241/15 duong Quan 6, phuong Trung Liet, quan Hoan Kiem, Thanh pho Quy Nhon, Tinh Binh Dinh', '09780244172', 'VP', 'CNPM', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40038', 'Bui Gia Phuc', 'NAM', TO_DATE('05/05/2004', 'DD/MM/YYYY'), '78/41H duong Lien Chieu, phuong Lach Tray, quan Tan Phu, Thanh pho Ha Noi', '09733966598', 'VP', 'CNPM', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40039', 'Ho Ngoc Hanh', 'NU', TO_DATE('29/09/2004', 'DD/MM/YYYY'), '198 duong Do Son, phuong Trang Minh, Thanh pho Viet Tri, Tinh Phu Tho', '09847994651', 'VP', 'CNPM', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40040', 'Hoang Cong Lap', 'NAM', TO_DATE('24/04/2002', 'DD/MM/YYYY'), '290 duong Ninh Kieu, phuong Thoi An Dong, Thanh pho Can Tho', '09474389882', 'VP', 'CNPM', 0, 0, 2 FROM DUAL;
INSERT INTO SINHVIEN
-- 3. SINH VIEN KHMT
--	1. CQ
	SELECT 'S10041', 'Dinh Hai Giang', 'NAM', TO_DATE('30/09/2002', 'DD/MM/YYYY'), '249L duong Quan 4, phuong Thuan An, Thanh pho Tam Ky, Tinh Quang Nam', '09091329499', 'CQ', 'KHMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10042', 'Truong Buu Chuong', 'NAM', TO_DATE('10/03/2001', 'DD/MM/YYYY'), '135/14 duong Quan 4, phuong Thoi Long, Thanh pho Ninh Binh, Tinh Ninh Binh', '09658407845', 'CQ', 'KHMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10043', 'Le Hai Quan', 'NAM', TO_DATE('02/01/2002', 'DD/MM/YYYY'), '163/35U duong Binh Thuy, phuong An Binh, Thanh pho Long Xuyen, Tinh An Giang', '09144659491', 'CQ', 'KHMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10044', 'Do Kim Hoang', 'NAM', TO_DATE('04/05/2000', 'DD/MM/YYYY'), '115/24 duong Kien An, phuong Trung Hoa, quan O Mon, Thanh pho Quang Ngai, Tinh Quang Ngai', '09903188205', 'CQ', 'KHMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10045', 'Ly Huyen Thoai', 'NU', TO_DATE('15/05/2000', 'DD/MM/YYYY'), '107/25 duong Hai Chau, phuong Thuong Dinh, Thanh pho Ha Long, Tinh Quang Ninh', '09870454619', 'CQ', 'KHMT', 0, 0, 1 FROM DUAL UNION ALL
--	2. CLC
	SELECT 'S20046', 'Vu Quang Lan', 'NAM', TO_DATE('09/12/2002', 'DD/MM/YYYY'), '373/19 duong Quan 7, phuong Hoa Hai, quan Duong Kinh, Thanh pho Ha Noi', '09689589123', 'CLC', 'KHMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20047', 'Vu Dinh Hop', 'NAM', TO_DATE('14/04/2004', 'DD/MM/YYYY'), '141V duong Hai An, phuong Duc Giang, quan Thot Not, Thanh pho Kon Tum, Tinh Kon Tum', '09424583119', 'CLC', 'KHMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20048', 'Bui Nguyet Cam', 'NU', TO_DATE('13/03/2003', 'DD/MM/YYYY'), '265/16N duong Quan 7, phuong Hoa Minh, quan Hong Bang, Thanh pho Lai Chau, Tinh Lai Chau', '09285876168', 'CLC', 'KHMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20049', 'Ly Minh Hung', 'NAM', TO_DATE('10/10/2001', 'DD/MM/YYYY'), '356/24 duong Binh Thanh, phuong Cau Ong Lanh, Thanh pho Gia Nghia, Tinh Dak Nong', '09878277209', 'CLC', 'KHMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20050', 'Bui Nghi Luc', 'NAM', TO_DATE('16/03/2000', 'DD/MM/YYYY'), '197W duong Long Bien, phuong Phuc Dien, Thanh pho Thai Binh, Tinh Thai Binh', '09535734165', 'CLC', 'KHMT', 0, 0, 1 FROM DUAL UNION ALL
--	3. CTTT
	SELECT 'S30051', 'Phan Minh Tu', 'NAM', TO_DATE('26/07/2000', 'DD/MM/YYYY'), '372/4 duong Ninh Kieu, phuong Cau Ong Lanh, Thanh pho My Tho, Tinh Tien Giang', '09636027829', 'CTTT', 'KHMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30052', 'Vo Thanh Tuan', 'NAM', TO_DATE('10/08/2003', 'DD/MM/YYYY'), '192/37K duong Go Vap, phuong Kim Lien, quan Dong Da, Thanh pho Hai Duong, Tinh Hai Duong', '09510957214', 'CTTT', 'KHMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30053', 'Duong Huong Xuan', 'NU', TO_DATE('27/08/2005', 'DD/MM/YYYY'), '48/47 duong Ngu Hanh Son, phuong Ha Dinh, Thanh pho Dien Bien Phu, Tinh Dien Bien', '09314064431', 'CTTT', 'KHMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30054', 'Bui Duc Phi', 'NAM', TO_DATE('10/09/2001', 'DD/MM/YYYY'), '262 duong Quan 1, phuong Yen So, quan Son Tra, Thanh pho Bac Ninh, Tinh Bac Ninh', '09864062257', 'CTTT', 'KHMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30055', 'Truong Hai Mien', 'NU', TO_DATE('29/01/2005', 'DD/MM/YYYY'), '251/43 duong Thanh Khe, Phuong 16, Thanh pho Dong Hoi, Tinh Quang Binh', '09808780654', 'CTTT', 'KHMT', 0, 0, 2 FROM DUAL UNION ALL
--	4. VP
	SELECT 'S40056', 'Vu My Dung', 'NU', TO_DATE('26/02/2003', 'DD/MM/YYYY'), '116/1T duong Quan 6, phuong Hung Vuong, Thanh pho Quang Ngai, Tinh Quang Ngai', '09892735073', 'VP', 'KHMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40057', 'Tran Huyen Thoai', 'NU', TO_DATE('12/09/2000', 'DD/MM/YYYY'), '112 duong Quan 10, phuong Binh Hung Hoa, Thanh pho Hai Phong', '09236510505', 'VP', 'KHMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40058', 'Hoang Dan Tam', 'NAM', TO_DATE('15/10/2001', 'DD/MM/YYYY'), '195 duong Ha Dong, phuong Truc Bach, Quan 12, Thanh pho Long Xuyen, Tinh An Giang', '09532238597', 'VP', 'KHMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40059', 'Le Minh Huan', 'NAM', TO_DATE('21/04/2000', 'DD/MM/YYYY'), '33/16N duong Cam Le, phuong Xuan Ha, Thanh pho Soc Trang, Tinh Soc Trang', '09642359466', 'VP', 'KHMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40060', 'Huynh Ha Tien', 'NU', TO_DATE('05/10/2000', 'DD/MM/YYYY'), '108/26 duong Quan 10, phuong Binh Tri Dong, Thanh pho Ben Tre, Tinh Ben Tre', '09954555250', 'VP', 'KHMT', 0, 0, 2 FROM DUAL;
INSERT INTO SINHVIEN
-- 4. SINH VIEN CNTT
--	1. CQ
	SELECT 'S10061', 'Dang Vang Anh', 'NU', TO_DATE('12/12/2002', 'DD/MM/YYYY'), '145 duong Hong Bang, phuong Cu Khoi, Thanh pho Hai Duong, Tinh Hai Duong', '09649113871', 'CQ', 'CNTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10062', 'Do Hoang Sa', 'NU', TO_DATE('07/06/2004', 'DD/MM/YYYY'), '326X duong Long Bien, phuong Trung Hoa, Thanh pho Tay Ninh, Tinh Tay Ninh', '09784448424', 'CQ', 'CNTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10063', 'Ly The Nang', 'NAM', TO_DATE('04/06/2005', 'DD/MM/YYYY'), '171/44D duong Hoang Mai, phuong Lieu Giai, quan Hoan Kiem, Thanh pho Hue, Tinh Thua Thien Hue', '09093525853', 'CQ', 'CNTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10064', 'Ly Hong Chau', 'NU', TO_DATE('04/11/2005', 'DD/MM/YYYY'), '373/25H duong Quan 12, phuong Xuan La, Thanh pho Ha Noi', '09978702520', 'CQ', 'CNTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10065', 'Dang Truong Vinh', 'NAM', TO_DATE('28/10/2001', 'DD/MM/YYYY'), '307K duong Hong Bang, phuong Trang Tien, Thanh pho Bien Hoa, Tinh Dong Nai', '09543183817', 'CQ', 'CNTT', 0, 0, 1 FROM DUAL UNION ALL
--	2. CLC
	SELECT 'S20066', 'Le An Co', 'NAM', TO_DATE('06/01/2003', 'DD/MM/YYYY'), '231G duong Hong Bang, Phuong 24, Thanh pho Thai Nguyen, Tinh Thai Nguyen', '09828513421', 'CLC', 'CNTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20067', 'Do Hiep Hao', 'NAM', TO_DATE('22/04/2003', 'DD/MM/YYYY'), '286/39 duong Hai Chau, phuong Viet Hung, quan Dong Da, Thanh pho Ha Noi', '09694390268', 'CLC', 'CNTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20068', 'Bui Quoc Vinh', 'NAM', TO_DATE('10/04/2003', 'DD/MM/YYYY'), '19 duong Quan 1, phuong Dien Bien, quan Le Chan, Thanh pho Dong Hoi, Tinh Quang Binh', '09512241256', 'CLC', 'CNTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20069', 'Ho Thien Manh', 'NAM', TO_DATE('18/10/2000', 'DD/MM/YYYY'), '3/20 duong Hai An, phuong Van Quan, Thanh pho Hung Yen, Tinh Hung Yen', '09802677572', 'CLC', 'CNTT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20070', 'Bui Khoi Vi', 'NAM', TO_DATE('20/04/2002', 'DD/MM/YYYY'), '277 duong Lien Chieu, Phuong Canh, Thanh pho Gia Nghia, Tinh Dak Nong', '09257983733', 'CLC', 'CNTT', 0, 0, 1 FROM DUAL UNION ALL
--	3. CTTT
	SELECT 'S30071', 'Vu Ngoc Canh', 'NAM', TO_DATE('18/01/2004', 'DD/MM/YYYY'), '159 duong Tan Binh, phuong Nam Son, Thanh pho Ha Giang, Tinh Ha Giang', '09639810350', 'CTTT', 'CNTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30072', 'Truong Long Giang', 'NAM', TO_DATE('05/12/2005', 'DD/MM/YYYY'), '145/47H duong Quan 12, phuong Dong Nhan, Thanh pho Hai Phong', '09877878116', 'CTTT', 'CNTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30073', 'Phan Thien Theu', 'NU', TO_DATE('11/08/2003', 'DD/MM/YYYY'), '90/26G duong Quan 7, phuong Sai Dong, Thanh pho Bac Ninh, Tinh Bac Ninh', '09336807978', 'CTTT', 'CNTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30074', 'Nguyen Hoang Kim', 'NU', TO_DATE('13/03/2003', 'DD/MM/YYYY'), '71/46O duong Phu Nhuan, phuong Thanh Loc, Thanh pho Bac Lieu, Tinh Bac Lieu', '09546517127', 'CTTT', 'CNTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30075', 'Ngo Nhat Hoang', 'NAM', TO_DATE('01/07/2001', 'DD/MM/YYYY'), '106/29 duong Quan 7, Phuong 21, Quan 8, Thanh pho Thu Dau Mot, Tinh Binh Duong', '09339570752', 'CTTT', 'CNTT', 0, 0, 2 FROM DUAL UNION ALL
--	4. VP
	SELECT 'S40076', 'Nguyen Duy Thong', 'NAM', TO_DATE('09/03/2004', 'DD/MM/YYYY'), '194/44T duong Quan 8, phuong Tan Phu, Thanh pho My Tho, Tinh Tien Giang', '09030705837', 'VP', 'CNTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40077', 'Pham Thanh Kieu', 'NU', TO_DATE('26/07/2003', 'DD/MM/YYYY'), '145 duong Thot Not, phuong Hoang Van Thu, Quan 12, Thanh pho Quy Nhon, Tinh Binh Dinh', '09067855365', 'VP', 'CNTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40078', 'Hoang Kim Thu', 'NU', TO_DATE('05/11/2001', 'DD/MM/YYYY'), '134/11 duong Ngo Quyen, phuong Dang Lam, Quan 12, Thanh pho Lai Chau, Tinh Lai Chau', '09826447488', 'VP', 'CNTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40079', 'Vu Truong Chinh', 'NAM', TO_DATE('01/12/2000', 'DD/MM/YYYY'), '25/1I duong Quan 3, phuong Ngoc Khanh, Thanh pho Viet Tri, Tinh Phu Tho', '09871780934', 'VP', 'CNTT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40080', 'Dang Dieu Nga', 'NU', TO_DATE('14/06/2000', 'DD/MM/YYYY'), '273 duong Son Tra, Xuan Phuong, Thanh pho Da Lat, Tinh Lam Dong', '09229090899', 'VP', 'CNTT', 0, 0, 2 FROM DUAL;
INSERT INTO SINHVIEN
-- 5. SINH VIEN TGMT
--	1. CQ
	SELECT 'S10081', 'Dinh Thu Suong', 'NU', TO_DATE('10/04/2003', 'DD/MM/YYYY'), '313J duong Quan 11, phuong Dong Mai, Thanh pho Bac Ninh, Tinh Bac Ninh', '09257332751', 'CQ', 'TGMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10082', 'Ly Khac Minh', 'NAM', TO_DATE('09/11/2003', 'DD/MM/YYYY'), '132Z duong Hoang Mai, phuong Hoa Thuan Tay, Thanh pho Tra Vinh, Tinh Tra Vinh', '09411692557', 'CQ', 'TGMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10083', 'Hoang Vuong Trieu', 'NAM', TO_DATE('22/05/2001', 'DD/MM/YYYY'), '213S duong Cam Le, phuong Cau Den, quan Duong Kinh, Thanh pho Quy Nhon, Tinh Binh Dinh', '09153238418', 'CQ', 'TGMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10084', 'Nguyen Khoi Phong', 'NAM', TO_DATE('15/08/2004', 'DD/MM/YYYY'), '260/36 duong Cau Giay, phuong Dai Mo, Thanh pho Vi Thanh, Tinh Hau Giang', '09382017165', 'CQ', 'TGMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10085', 'Le Phuong Bich', 'NU', TO_DATE('09/04/2005', 'DD/MM/YYYY'), '1U duong Quan 12, phuong Hung Thanh, quan Cai Rang, Thanh pho Bac Kan, Tinh Bac Kan', '09513612446', 'CQ', 'TGMT', 0, 0, 1 FROM DUAL UNION ALL
--	2. CLC
	SELECT 'S20086', 'Truong Thanh Nhan', 'NAM', TO_DATE('22/07/2005', 'DD/MM/YYYY'), '27/46 duong Phu Nhuan, phuong Hung Loi, quan Hai Ba Trung, Thanh pho Ninh Binh, Tinh Ninh Binh', '09944592933', 'CLC', 'TGMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20087', 'Vu Ngoc Diep', 'NU', TO_DATE('16/11/2003', 'DD/MM/YYYY'), '158/17I duong Binh Thuy, phuong Phuc La, Thanh pho Buon Ma Thuot, Tinh Dak Lak', '09377720142', 'CLC', 'TGMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20088', 'Dang Duc Quang', 'NAM', TO_DATE('27/11/2000', 'DD/MM/YYYY'), '329/9H duong Tan Phu, phuong Tan Thanh, Quan 3, Thanh pho Tam Ky, Tinh Quang Nam', '09539143935', 'CLC', 'TGMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20089', 'Tran Viet Cuong', 'NAM', TO_DATE('04/03/2004', 'DD/MM/YYYY'), '310 duong Cau Giay, phuong Binh Hung Hoa A, Thanh pho Tay Ninh, Tinh Tay Ninh', '09194959785', 'CLC', 'TGMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20090', 'Phan Ham Y', 'NU', TO_DATE('06/08/2001', 'DD/MM/YYYY'), '88/34 duong Ngo Quyen, phuong Lam Ha, quan Duong Kinh, Thanh pho Vinh, Tinh Nghe An', '09885520208', 'CLC', 'TGMT', 0, 0, 1 FROM DUAL UNION ALL
--	3. CTTT
	SELECT 'S30091', 'Hoang Minh Quang', 'NAM', TO_DATE('12/12/2004', 'DD/MM/YYYY'), '25V duong Go Vap, phuong Phu Lien, quan Hai Ba Trung, Thanh pho Hoa Binh, Tinh Hoa Binh', '09048865482', 'CTTT', 'TGMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30092', 'Nguyen Nhat Quang', 'NAM', TO_DATE('03/03/2005', 'DD/MM/YYYY'), '244/30F duong Tan Binh, phuong Thuong Dinh, Thanh pho Yen Bai, Tinh Yen Bai', '09906132024', 'CTTT', 'TGMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30093', 'Bui Phuong Lien', 'NU', TO_DATE('07/04/2004', 'DD/MM/YYYY'), '248/49 duong Hoang Mai, phuong Long Hung, Thanh pho Buon Ma Thuot, Tinh Dak Lak', '09089051329', 'CTTT', 'TGMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30094', 'Tran Hoang Mien', 'NU', TO_DATE('16/05/2000', 'DD/MM/YYYY'), '297A duong Quan 1, phuong Kim Lien, quan Hai Ba Trung, Thanh pho Vinh, Tinh Nghe An', '09121365995', 'CTTT', 'TGMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30095', 'Vo Cong Son', 'NAM', TO_DATE('29/12/2005', 'DD/MM/YYYY'), '112/39 duong Binh Thanh, phuong Thoi Hoa, quan Lien Chieu, Thanh pho Long Xuyen, Tinh An Giang', '09037809369', 'CTTT', 'TGMT', 0, 0, 2 FROM DUAL UNION ALL
--	4. VP
	SELECT 'S40096', 'Vo Thuy Du', 'NU', TO_DATE('14/05/2002', 'DD/MM/YYYY'), '80/47 duong Quan 6, phuong An Hai Bac, Thanh pho Vinh, Tinh Nghe An', '09126823934', 'VP', 'TGMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40097', 'Truong Minh Ly', 'NAM', TO_DATE('02/12/2005', 'DD/MM/YYYY'), '292/22F duong Cau Giay, phuong Gia Thuy, Thanh pho Thai Binh, Tinh Thai Binh', '09236189183', 'VP', 'TGMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40098', 'Dinh Thao Hong', 'NU', TO_DATE('06/10/2000', 'DD/MM/YYYY'), '53/14S duong Tan Binh, phuong Cat Bi, Quan 1, Thanh pho Phan Rang - Thap Cham, Tinh Ninh Thuan', '09089025497', 'VP', 'TGMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40099', 'Huynh Tieu My', 'NU', TO_DATE('19/11/2004', 'DD/MM/YYYY'), '259/49 duong O Mon, phuong Nguyen Trai, Thanh pho Ha Noi', '09995989582', 'VP', 'TGMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40100', 'Dang Lien Tran', 'NU', TO_DATE('29/10/2002', 'DD/MM/YYYY'), '301 duong Binh Tan, phuong Tan Thoi Nhat, Thanh pho Lai Chau, Tinh Lai Chau', '09267964509', 'VP', 'TGMT', 0, 0, 2 FROM DUAL;
INSERT INTO SINHVIEN
-- 6. SINH VIEN MMT
--	1. CQ
	SELECT 'S10101', 'Vu Bich Thu', 'NU', TO_DATE('12/07/2000', 'DD/MM/YYYY'), '113 duong Hai Ba Trung, phuong Hoa Thuan Dong, Thanh pho Long Xuyen, Tinh An Giang', '09474510822', 'CQ', 'MMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10102', 'Nguyen Hanh Linh', 'NU', TO_DATE('06/02/2000', 'DD/MM/YYYY'), '349D duong Do Son, Phuong 24, Quan 3, Thanh pho Buon Ma Thuot, Tinh Dak Lak', '09764619344', 'CQ', 'MMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10103', 'Ly Minh Huy', 'NAM', TO_DATE('06/01/2005', 'DD/MM/YYYY'), '28/30 duong Quan 11, phuong Truong Dinh, quan Nam Tu Liem, Thanh pho Thai Nguyen, Tinh Thai Nguyen', '09269554150', 'CQ', 'MMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10104', 'Vu Nhu Khang', 'NAM', TO_DATE('04/04/2001', 'DD/MM/YYYY'), '185 duong Quan 7, phuong Thanh Xuan Trung, quan Ha Dong, Thanh pho Ben Tre, Tinh Ben Tre', '09388098498', 'CQ', 'MMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S10105', 'Nguyen Loc Uyen', 'NU', TO_DATE('22/01/2005', 'DD/MM/YYYY'), '360 duong Long Bien, phuong Dong Nhan, Thanh pho Dong Xoai, Tinh Binh Phuoc', '09345951090', 'CQ', 'MMT', 0, 0, 1 FROM DUAL UNION ALL
--	2. CLC
	SELECT 'S20106', 'Truong Phi Hai', 'NAM', TO_DATE('16/12/2000', 'DD/MM/YYYY'), '254/7 duong Son Tra, phuong Dong Mac, Quan 8, Thanh pho Kon Tum, Tinh Kon Tum', '09547187903', 'CLC', 'MMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20107', 'Duong Duc Tue', 'NAM', TO_DATE('13/11/2005', 'DD/MM/YYYY'), '36 duong Binh Tan, phuong Lach Tray, Thanh pho Tuy Hoa, Tinh Phu Yen', '09049921906', 'CLC', 'MMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20108', 'Truong Duy Thanh', 'NAM', TO_DATE('04/02/2000', 'DD/MM/YYYY'), '150/31T duong Lien Chieu, phuong Van Mieu, quan Tan Phu, Thanh pho Thanh Hoa, Tinh Thanh Hoa', '09061426542', 'CLC', 'MMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20109', 'Huynh Chien Thang', 'NAM', TO_DATE('08/12/2003', 'DD/MM/YYYY'), '136 duong Ha Dong, phuong Trung Hoa, quan Ngo Quyen, Thanh pho Dong Xoai, Tinh Binh Phuoc', '09406014245', 'CLC', 'MMT', 0, 0, 1 FROM DUAL UNION ALL
	SELECT 'S20110', 'Hoang Van Thang', 'NAM', TO_DATE('04/12/2005', 'DD/MM/YYYY'), '13/2K duong Tan Phu, phuong Tay Mo, quan Hoan Kiem, Thanh pho Nam Dinh, Tinh Nam Dinh', '09367370468', 'CLC', 'MMT', 0, 0, 1 FROM DUAL UNION ALL
--	3. CTTT
	SELECT 'S30111', 'Le Viet Khang', 'NAM', TO_DATE('10/06/2001', 'DD/MM/YYYY'), '110/33J duong Tan Binh, phuong Tan Phu, Thanh pho Son La, Tinh Son La', '09830343697', 'CTTT', 'MMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30112', 'Nguyen Thai Duong', 'NAM', TO_DATE('11/07/2002', 'DD/MM/YYYY'), '4 duong Tay Ho, Phuong 8, Quan 1, Thanh pho Phu Ly, Tinh Ha Nam', '09488448110', 'CTTT', 'MMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30113', 'Phan Nhat Thinh', 'NAM', TO_DATE('29/03/2005', 'DD/MM/YYYY'), '178F duong Quan 1, phuong Bach Khoa, Thanh pho Ha Long, Tinh Quang Ninh', '09024323328', 'CTTT', 'MMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30114', 'Pham Gia Phuoc', 'NAM', TO_DATE('21/05/2000', 'DD/MM/YYYY'), '88/41 duong Binh Thuy, phuong Phan Boi Chau, quan Ngu Hanh Son, Thanh pho Da Lat, Tinh Lam Dong', '09214304807', 'CTTT', 'MMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S30115', 'Dinh Hai Vy', 'NU', TO_DATE('14/05/2001', 'DD/MM/YYYY'), '161/27F duong Hai An, phuong Hoa Thuan Dong, Thanh pho Lai Chau, Tinh Lai Chau', '09975597818', 'CTTT', 'MMT', 0, 0, 2 FROM DUAL UNION ALL
--	4. VP
	SELECT 'S40116', 'Phan Manh Quynh', 'NAM', TO_DATE('01/04/2002', 'DD/MM/YYYY'), '174P duong Bac Tu Liem, phuong An Lac, Thanh pho Ha Long, Tinh Quang Ninh', '09953789284', 'VP', 'MMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40117', 'Pham Thuc Tam', 'NU', TO_DATE('15/05/2000', 'DD/MM/YYYY'), '192 duong Thanh Xuan, Phuong 4, quan Hoan Kiem, Thanh pho Son La, Tinh Son La', '09506492978', 'VP', 'MMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40118', 'Le Thuy Tram', 'NU', TO_DATE('26/05/2002', 'DD/MM/YYYY'), '153B duong Do Son, phuong Hung Phu, Thanh pho Phan Rang - Thap Cham, Tinh Ninh Thuan', '09362853790', 'VP', 'MMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40119', 'Ly Quang Minh', 'NAM', TO_DATE('12/06/2001', 'DD/MM/YYYY'), '256/33U duong Ngu Hanh Son, phuong Nguyen Thai Binh, Thanh pho Thanh Hoa, Tinh Thanh Hoa', '09406997346', 'VP', 'MMT', 0, 0, 2 FROM DUAL UNION ALL
	SELECT 'S40120', 'Hoang Mai Thy', 'NU', TO_DATE('22/06/2003', 'DD/MM/YYYY'), '253/20V duong Duong Kinh, phuong An Duong, quan Hoan Kiem, Thanh pho Cao Bang, Tinh Cao Bang', '09056274293', 'VP', 'MMT', 0, 0, 2 FROM DUAL;
