...
BEGIN EXECUTE IMMEDIATE 'DROP USER A01_QLNOIBO CASCADE';
...
-- 1. NV (10): NHAN VIEN CO BAN    4. TD (12): TRUONG DON VI
-- 2. V (80): GIANG VIEN           5. TK (1): TRUONG KHOA
-- 3. GV (10): GIAO VU
CREATE TABLE NHANSU (
